...
class Summa_general():
    def __init__(self, path, HOST_NAME="localhost", user_name = None, task_path="" ,jobName='Test',nTimes=1,
    ...
    #summaFolder = Text(value = self.summaFolder)
        ...
        def upload_task():
            ...
            summaTestDirPath = self.folderpath
        ...
        def monitorDeamon(interval=1):
            ...
            output.value+='<br>The output should be in your Jupyter <a href="output/Test/ouput1/wrrPaperTestCases">login folder</font>' 
