...
class SummaKeelingJob(KeelingJob):
    ...
    def __init__(self, local_workspace_path, connection, sbatch_script,
                 ...
                 model_source_fpath="", move_source=False,
                 *args, **kwargs):
        ...
        self.model_source_fpath = model_source_fpath
    ...
    def prepare(self):
        ...
        if self.move_source:
            self.move_local(self.model_source_fpath,
                            self.local_job_folder_path)
        else:
            self.copy_local(self.model_source_fpath,
                            self.local_job_folder_path)
        # save SBatch script
